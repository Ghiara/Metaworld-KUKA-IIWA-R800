from metaworld.envs.mujoco.kuka_xyz.kuka_reach_v2 import KukaReachEnvV2
from metaworld.envs.mujoco.kuka_xyz.kuka_push_v2 import KukaPushEnvV2
...
from metaworld.envs.mujoco.kuka_xyz.kuka_window_close_v2 import KukaWindowCloseEnvV2
