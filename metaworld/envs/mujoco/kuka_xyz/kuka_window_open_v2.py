...
class KukaWindowOpenEnvV2(KukaXYZEnv):
    ...
    def __init__(self):
        ...
        # obj_low = (-0.1, 0.65, 0.16)
        # obj_high = (0.1, 0.75, 0.16)
        obj_low = (0.0, 0.88, 0.16)
        obj_high = (0.02, 0.885, 0.16)
        ...
        self.init_config = {
            ...
            'obj_init_pos': np.array([0.0, 0.88, 0.16], dtype=np.float32), # this decide the obj pos
