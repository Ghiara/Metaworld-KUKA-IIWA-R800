...
class KukaPegUnplugSideEnv(KukaXYZEnv):
    ...
    def __init__(self):
        ...
        self.init_config = {
            'obj_init_pos': np.array([-0.225, 0.7, 0.05]),
    ...
    @property
    def model_name(self):
        return get_asset_full_path('kuka_xyz/kuka_peg_unplug_side.xml')
